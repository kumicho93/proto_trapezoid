	...
	const float vs, const float vt, const float d)
{
	...
	float am			= 0.0f;					/* 最大加速度				 */
	float jm			= 0.0f;					/* 最大躍度					 */
	float d_triangle	= 0.0f;					/* 等減速値					 */
	float v_triangle	= 0.0f;					/* 等加速値					 */
	float amtc			= 0.0f;					/* 演算速度					 */
	float D				= 0.0f;					/* 2次方程式の途中演算行	 */
	float sqrtD			= 0.0f;					/* 2次方程式の2乗根			 */
	float a				= 0.0f;					/* 3次方程式パラメータ		 */
	float b				= 0.0f;					/* 3次方程式パラメータ		 */
	float aaa			= 0.0f;					/* 3次方程式パラメータ		 */
	float c0			= 0.0f;					/* 3次方程式パラメータ		 */
	float c1			= 0.0f;					/* 3次方程式パラメータ		 */
	float c2			= 0.0f;					/* 3次方程式パラメータ		 */
